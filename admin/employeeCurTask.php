...
include 'db.php';
$id = $_GET['id'];
$sql = "SELECT * FROM `all_task` WHERE `userID`='$id' && `status`='1'";
...
<div class="content-wrapper fiber">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<h2 class="fac_title wow animated fadeInDownBig">
				<i class="fa fa-bullseye" aria-hidden="true"></i> Employee current task
			</h2>
		</div>
	</div>
	<div class="row">
		<div class="col-md-8 col-sm-8 col-lg-8 col-xs-12 col-lg-offset-2 col-sm-offset-2 col-md-offset-2 formaria wow animated zoomIn">
			...
			<h4>
				...
				Task status: <div class="progress">
  					...
  					aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo $data['taskStatus']; ?>%; color:red">
